        ...
        <PostHeader>
          ...
          <HeaderProfile>
            ...
            <Link href="mailto:dev.osolku@naver.com" target="_blank" rel="noreferrer">
              <LinkWrap>
                <svg viewBox="0 0 20 20" fill="#f9fafb" style={{width: "32px", height: "32px"}} >
            ...
            <Link href="https://velog.io/@yojeongjin" target="_blank" rel="noreferrer">
              <LinkWrap>
            ...
            <Link href="https://github.com/yojeongjin" target="_blank" rel="noreferrer">
              <LinkWrap>
                <svg fill="#f9fafb" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" style={{width: "32px", height: "32px"}} >
...
&::before {
  ...
  backdrop-filter: ${(props) => props.theme.saturate};
}
`
...
padding: 20px 40px;
color: ${(props) => props.isSelect ? props.theme.themeColor : "#717790c7" };
border-bottom: 2px solid ${(props) => props.isSelect ? props.theme.themeColor : "transparent" };
transition: 0.3s;
&:hover {
